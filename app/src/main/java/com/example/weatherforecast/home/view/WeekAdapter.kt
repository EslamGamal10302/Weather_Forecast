...
class WeekAdapter(var context: Context, var myWeekWeather: List<Daily>) :
    ...
    override fun onBindViewHolder(holder: WeekViewHolder, position: Int) {
        ...
        if (language.equals("en")) {
            ...
            finalTemp =
                if (units.equals("standard")) "$max/$min °ك " else if (units.equals("metric")) "$max/$min°س " else "$max/$min°ف "
        }
